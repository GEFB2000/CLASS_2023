...
path <- "CLASS_2023/CLASSES/03_Nextflow/chipseq/results/bwa/mergedLibrary/macs/broadPeak"
...
peaks_1_tsv <- read_tsv(file.path(basepath,path, "POLR2A_R1_peaks.broadPeak"), colnames = FALSE)
