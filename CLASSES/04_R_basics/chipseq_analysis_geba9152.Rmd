---
title: "chipseq_analysis_geba9152"
...
```{reading in file paths & loading genome features}
...
```{Making tsv files for samples}

#pSer2 and pSer5, reading in file in tsv format
...
table(table(TBP_R1_tsv))
table(table(TBP_R2_tsv))

table(table(H3K36me3_R1_tsv))
table(table(H3K36me3_R2_tsv))
```
...
# Let's look at how many promoters contained the pSer2 phospho mark on Pol II
...
# Let's look at how many promoters contained the pSer5 phospho mark on Pol II

length(promoter_overlaps_HeK36me3_R1) 
#7594 promoters out of 60609 (HeK36me3_R1 is found at 12.5% of promoters)
length(promoter_overlaps_HeK36me3_R2) 
...
subset_overlaps_promoter_H3K36me3_peaks <- findOverlaps(promoter_overlaps_HeK36me3_R1, promoter_overlaps_H3K36me3_R2)

length(subset_overlaps_promoter_H3K36me3_peaks) 
#5689 peaks at promoters, meaning, pSer2_R1 and pSer2_R2 were enriched at 5689 of the same promoters
...
```{How many unique peaks had overlaps}
...
```
```{Peak overlaps and promoter overlaps}
