...
setwd("/scratch/Shares/rinnclass/CLASS_2023/geba9152/CLASS_2023/CLASSES/05_R_analyses/00_consensus_peaks")
...
basepath <- "/scratch/Shares/rinnclass/CLASS_2023/chipseqprofs"
consensus_path <- "/scratch/Shares/rinnclass/CLASS_2023/geba9152/CLASS_2023/CLASSES/05_R_analyses/00_consensus_peaks/"
exportpath <- "/scratch/Shares/rinnclass/CLASS_2023/geba9152/CLASS_2023/CLASSES/05_R_analyses/00_consensus_peaks/consensus_peaks/"
...
# STEP 4 : cleaning up .bed file basics adding col names
```{r reading .bed file from rtracklayer_export}
# FIRST a file list:
consensus_file_list <- list.files("/scratch/Shares/rinnclass/CLASS_2023/geba9152/CLASS_2023/CLASSES/05_R_analyses/00_consensus_peaks", full.names = T, pattern = ".bed")
...
consensus_peak_path <- "CLASS_2023/CLASSES/05_R_analyses/00_consensus_peaks"

# input into function
consensusFilePath <- '/scratch/Shares/rinnclass/CLASS_2023/geba9152/CLASS_2023/CLASSES/05_R_analyses/00_consensus_peaks/consensus_peaks'

# input into function
exportpath <- "/scratch/Shares/rinnclass/CLASS_2023/geba9152/CLASS_2023/CLASSES/05_R_analyses/00_consensus_peaks/test"
...
headers <- paste0("track type=bedGraph name=", names(peaks))
new_filenames <- paste0("test/", names(peaks), ".bed")
