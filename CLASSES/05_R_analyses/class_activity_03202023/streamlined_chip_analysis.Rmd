...
H3K36me3 peak overlaps with promoters: 2179, 0.65% of all promoters
JUN peak overlaps with promoters: 700, 3.65% of all promoters
MAX peak overlaps with promoters: 18524, 17.06% of all promoters
POL2RA peak overlaps with promoters: 5102, 21.71% of all promoters
POL2RA phosphoS2 peak overlaps with promoters: 8411, 4.40% of all promoters
POL2RA phosphoS5 peak overlaps with promoters: 17143, 6.98% of all promoters
...
# Ask tomorrow if this is correct (getting these values by going into the peak_occurence_df)
...
## Result:
 Yes there is a relationship between peak number and total DNA covered, the more number of peaks, the more DNA covered. See below:
```{r}
