...
### TODO: Filter out any chip data less 1,000 peaks == filtered consensus peaks
...
write.csv(no_exp_high_binder_tpm, "results\no_exp_high_binder_tpm.csv", row.names=TRUE)
